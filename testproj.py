...
# driver.find_elements_by_class_name("thumbnail",[data-ember-action="1145"]).click()
# driver.find_element_by_id("ember1145")
# element = driver.find_elements_by_name("thumbnail")
